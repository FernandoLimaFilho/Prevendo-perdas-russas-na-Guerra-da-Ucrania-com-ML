...
# <img src = "200.gif" width = 300 height = 200 />

# # $\color{orange}{\textbf{1. Importando as bibliotecas}}$
...
# # $\color{orange}{\textbf{2. Importação dos dados}}$
...
# # $\color{orange}{\textbf{3. Pré-processamento de dados}}$
...
# # $\color{orange}{\textbf{3.1 Dados faltantes}}$
...
# # $\color{orange}{\textbf{3.2 Análise de dados}}$
...
# # $\color{orange}{\textbf{4. Previsão das séries temporais}}$
